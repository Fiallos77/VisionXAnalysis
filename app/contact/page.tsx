              ...
              {submitted ? (
                ...
                >
                  ...
                  <p className="text-text-secondary text-sm">
                    Thank you for reaching out to Vision X Analysis. We
                ...
                <div className="space-y-6">
                  ...
                  >
                    ...
                    <div className="grid grid-cols-1 gap-3 max-w-xs">
                      <button
                        onClick={() =>
                          setFormData({ ...formData, category: "player" })
                        }
            ...
            >
              ...
              <div className="card-base p-6">
                ...
                <p className="text-text-secondary text-sm leading-relaxed">
                  We can produce bespoke player profiles on request. Please
                  include the player name, club, position and league when
                  enquiring.
                </p>
              </div>
              ...
              <div className="card-base p-6">
                ...
                <ul className="space-y-2">
                  {[
                    ...
                    >
                      <span className="text-accent-green shrink-0 mt-0.5">
                        →
                      </span>
                      {item}
                    </li>

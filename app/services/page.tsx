        ...
        <section className="container-px max-w-screen-xl mx-auto py-16">
          ...
          >
            ...
            <div className="flex-1">
              ...
              <p className="text-text-secondary text-sm leading-relaxed">
                Send us a message and we will help you choose based on your
                goals — whether you are preparing for a transfer or trial,
                looking to attract interest from clubs, or simply want to

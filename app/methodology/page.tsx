                ...
                <div className="grid md:grid-cols-[1fr_220px] gap-8">
                  ...
                  <div className="bg-pitch-card border border-pitch-border rounded-xl p-5 self-start">
                    ...
                    <ul className="space-y-2">
                      {step.details.map((d) => (
                        <li key={d} className="flex items-start gap-2 text-text-secondary text-xs">
        ...
        <section className="bg-pitch-dark border-y border-pitch-border">
          <div className="container-px max-w-screen-xl mx-auto py-20">
            ...
            >
              ...
              <h2 className="display-heading text-3xl md:text-4xl">What Drives Our Work</h2>
            </motion.div>
            ...
            <div className="grid md:grid-cols-3 gap-5">
              {[
                ...
                >
                  ...
                  <h3 className="font-display font-bold text-xl text-text-primary mb-3">{principle.title}</h3>
